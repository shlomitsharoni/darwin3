...
.. csv-table:: Namelist DARWIN_TRAITS
   ...
   :varlink:`phytoTempAe`      & :math:`$\phytoTempAe$`                 & 1/°C                                          & see :numref:`pkg_darwin_temperature_params`
   ...
   :varlink:`hetTempAe`        & :math:`$\hetTempAe$`                   & 1/°C                                          & see :numref:`pkg_darwin_temperature_params`
   :varlink:`hetTempExp2`      & :math:`$\hetTempExpii$`                &                                               & see :numref:`pkg_darwin_temperature_params`
   :varlink:`hetTempOptimum`   & :math:`$\hetTempOptimum$`              & °C                                            & see :numref:`pkg_darwin_temperature_params`
   :varlink:`hetDecayPower`    & :math:`$\hetDecayPower$`               &                                               & see :numref:`pkg_darwin_temperature_params`
   :varlink:`grazTempAe`       & :math:`$\grazTempAe$`                  & 1/°C                                          & see :numref:`pkg_darwin_temperature_params`
   :varlink:`grazTempExp2`     & :math:`$\grazTempExpii$`               &                                               & see :numref:`pkg_darwin_temperature_params`
   :varlink:`grazTempOptimum`  & :math:`$\grazTempOptimum$`             & °C                                            & see :numref:`pkg_darwin_temperature_params`
   :varlink:`grazDecayPower`   & :math:`$\grazDecayPower$`              &                                               & see :numref:`pkg_darwin_temperature_params`
...
.. table:: Darwin package diagnstic fields
   ...
   +------------+------------------+---------------------------------+------------------------------------------------------------------------------------------------------------+
   | gDAR##     | ``SMR_____MR``   |                                 | ptracer ## tendency from DARWIN [#a]_                                                                      |
   +------------+------------------+---------------------------------+------------------------------------------------------------------------------------------------------------+
