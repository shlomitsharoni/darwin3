...
.. csv-table:: Uptake parameters
   ...
   :varlink:`Qnmin`    & :varlink:`a,b_Qnmin`      & :math:`Q^{\op{N}\min}_j`        & 0.07 V\ :sup:`--0.17`        & mmol N / mmol C      & minimum nitrogen quota
   :varlink:`Qnmax`    & :varlink:`a,b_Qnmax`      & :math:`Q^{\op{N}\op{max}}_j`    & 0.25 V\ :sup:`--0.13`        & mmol N / mmol C      & maximum nitrogen quota
   :varlink:`Qpmin`    & :varlink:`a,b_Qpmin`      & :math:`Q^{\op{P}\min}_j`        & 0.002                        & mmol P / mmol C      & minimum phosphorus quota
   :varlink:`Qpmax`    & :varlink:`a,b_Qpmax`      & :math:`Q^{\op{P}\op{max}}_j`    & 0.01                         & mmol P / mmol C      & maximum phosphorus quota
   :varlink:`Qsimin`   & :varlink:`a,b_Qsimin`     & :math:`Q^{\op{Si}\min}_j`       & 0.002                        & mmol Si / mmol C     & minimum silica quota
   :varlink:`Qsimax`   & :varlink:`a,b_Qsimax`     & :math:`Q^{\op{Si}\op{max}}_j`   & 0.004                        & mmol Si / mmol C     & maximum silica quota
   :varlink:`Qfemin`   & :varlink:`a,b_Qfemin`     & :math:`Q^{\op{Fe}\min}_j`       & 15E-6                        & mmol Fe / mmol C     & minimum iron quota
   :varlink:`Qfemax`   & :varlink:`a,b_Qfemax`     & :math:`Q^{\op{Fe}\op{max}}_j`   & 80E-6                        & mmol Fe / mmol C     & maximum iron quota
   :varlink:`vmaxNO3`  & :varlink:`a,b_vmaxNO3`    & :math:`V^{\op{NO3}\op{max}}_j`  & (0.26/day)  V\ :sup:`--0.27` & mmol N / (mmol C s)  & maximum nitrate uptake rate
   :varlink:`vmaxNO2`  & :varlink:`a,b_vmaxNO2`    & :math:`V^{\op{NO2}\op{max}}_j`  & (0.51/day)  V\ :sup:`--0.27` & mmol N / (mmol C s)  & maximum nitrite uptake rate
   :varlink:`vmaxNH4`  & :varlink:`a,b_vmaxNH4`    & :math:`V^{\op{NH4}\op{max}}_j`  & (0.51/day)  V\ :sup:`--0.27` & mmol N / (mmol C s)  & maximum ammonia uptake rate
   :varlink:`vmaxN`    & :varlink:`a,b_vmaxN`      & :math:`V^{\op{N}\op{max}}_j`    & (1.28/day)  V\ :sup:`--0.27` & mmol N / (mmol C s)  & maximum nitrogen uptake rate for diazotrophs
   :varlink:`vmaxPO4`  & :varlink:`a,b_vmaxPO4`    & :math:`V^{\op{PO4}\op{max}}_j`  & (0.077/day) V\ :sup:`--0.27` & mmol P / (mmol C s)  & maximum phosphate uptake rate
   :varlink:`vmaxSiO2` & :varlink:`a,b_vmaxSiO2`   & :math:`V^{\op{SiO2}\op{max}}_j` & (0.077/day) V\ :sup:`--0.27` & mmol Si / (mmol C s) & maximum silica uptake rate
   :varlink:`vmaxFeT`  & :varlink:`a,b_vmaxFeT`    & :math:`V^{\op{Fe}\op{max}}_j`   & (14E-6/day) V\ :sup:`--0.27` & mmol Fe / (mmol C s) & maximum iron uptake rate
   :varlink:`ksatNO3`  & :varlink:`a,b_ksatNO3`    & :math:`k^{\op{NO3}}_j`          & 0.085 V\ :sup:`0.27`         & mmol N m\ :sup:`-3`  & half-saturation conc. for nitrate uptake/limitation
   :varlink:`ksatNO2`  & :varlink:`a,b_ksatNO2`    & :math:`k^{\op{NO2}}_j`          & 0.17  V\ :sup:`0.27`         & mmol N m\ :sup:`-3`  & half-saturation conc. for nitrite uptake/limitation
   :varlink:`ksatNH4`  & :varlink:`a,b_ksatNH4`    & :math:`k^{\op{NH4}}_j`          & 0.17  V\ :sup:`0.27`         & mmol N m\ :sup:`-3`  & half-saturation conc. for ammonia uptake/limitation
   :varlink:`ksatPO4`  & :varlink:`a,b_ksatPO4`    & :math:`k^{\op{PO4}}_j`          & 0.026 V\ :sup:`0.27`         & mmol P m\ :sup:`-3`  & half-saturation conc. for phosphate uptake/limitation
   :varlink:`ksatSiO2` & :varlink:`a,b_ksatSiO2`   & :math:`k^{\op{SiO2}}_j`         & 0.024 V\ :sup:`0.27`         & mmol Si m\ :sup:`-3` & half-saturation conc. for silica uptake/limitation
   :varlink:`ksatFeT`  & :varlink:`a,b_ksatFeT`    & :math:`k^{\op{Fe}}_j`           & 80E-6 V\ :sup:`0.27`         & mmol Fe m\ :sup:`-3` & half-saturation conc. for iron uptake/limitation
                       & :varlink:`a,b_ksatNO2fac` &                                 & 1                            &                      & *used for eff.ksat*
                       & :varlink:`a,b_ksatNH4fac` &                                 & 0.5                          &                      & *used for eff.ksat*
